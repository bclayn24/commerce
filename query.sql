...
INSERT INTO listings (title, starting_price, description, owner_id, image_url, created_at, category_id)
VALUES (?, ?, ?, ?, ?, ?, ?);
...
-- name: CreateBid :exec
INSERT INTO bids (amount, user_id, listing_id, owner_name)
VALUES (?, ?, ?, ?);
...
INSERT INTO comments (COMMENT, listing_id, owner_id, owner_name)
VALUES (?, ?, ?, ?);